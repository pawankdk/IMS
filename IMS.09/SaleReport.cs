        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionstring))
                {
                    ...
                    cmd.CommandText = @"Select m.TransactionDate, cs.Name, p.ProductName , c.CategoryName,u.UnitName,m.GrandTotal,m.Vat,m.Discount,d.Quantity,d.Rate as [Sale Rate], d.Total from TransactionDetail d inner join tblTransactionMaster m on m.TransactionMasterId=d.TransactionMasterId 
